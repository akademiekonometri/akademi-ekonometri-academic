...
slug: r-kodu-ornek
categories: [R]
tags: [örnek gönderi, grafik, R Markdown, regresyon]
subtitle: ""
...
Ayrıca bu videoya ait data ve R kodlarına aşağıdaki simgelere tıklayarak erişebilirsiniz.  
`test.xls` datası ve `R` kodu: [![](/repo/images/excel-icon.png "test.xls"){width=25px height=25px}](test.xls)[![test.R](/repo/images/rscript-icon.ico "test.R"){width=25px height=25px}](test.R)  
`CPI.csv` datası ve `R` kodu: [![](/repo/images/csv-icon.png "CPI.csv"){width=25px height=25px}](CPI.csv) [![](/repo/images/rscript-icon.ico "CPI.R"){width=25px height=25px}](CPI.R)
