#===================== Granger.Causality.TYDL.Multivariate =====================
#================== Granger Causality TYDL Multivariate Tests ==================

# Notes:
#
## Function runs the multivariate TYDL version of Granger Causality tests.
...
## The outputs of the function are named as "granger.causality.TYDL.multivariate.results" data frames.

# Usage:
#
# Granger.Causality.TYDL.Multivariate(Data, Int.Numbers, Lag = "AIC", Deterministic = "Constant", Season = NULL, Exogen = NULL, LaTeX = FALSE)
#
...
# Examples:
#
## Granger.Causality.TYDL.Multivariate(Data = data.ts, Int.Numbers = int.numbers)
## Granger.Causality.TYDL.Multivariate(Data = data.ts, Int.Numbers = int.numbers, Lag = "BIC")
## Granger.Causality.TYDL.Multivariate(Data = data.ts, Int.Numbers = int.numbers, Lag = "HQ", Deterministic = "Trend", LaTeX = TRUE)
## Granger.Causality.TYDL.Multivariate(Data = data.ts, Int.Numbers = int.numbers, Lag = "FPE", Season = TRUE, Exogen = exogenous.ts, LaTeX = TRUE)

Granger.Causality.TYDL.Multivariate <- function(Data, Int.Numbers, Lag = "AIC", Deterministic = "Constant", Season = NULL, Exogen = NULL, LaTeX = FALSE) {
    ...
    # Multivariate VAR Analysis: Granger Causality TYDL Multivariate tests.
    ts <- Data
    ...
    # Output data will be named as "granger.causality.TYDL.multivariate.results".
    assign("granger.causality.TYDL.multivariate.results", main, envir = globalenv())
