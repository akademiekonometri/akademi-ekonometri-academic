...
- Daha sonra Model 1 tahminini kullanarak aşağıdaki hipotezleri [`FSA`](https://cran.r-project.org/web/packages/FSA/index.html) R paketindeki `hoCoef` fonksiyonuyla test edelim.
    + Hipotez Testi 1 (Çift Kuyruk $t$-testi): $H_{0}: \beta_{1} = 0 \;\; \text{vs.} \;\; H_{1}: \beta_{1} \neq 0$
...
- Son olarak Model 4 tahminini kullanarak aşağıdaki hipotezleri [`FSA`](https://cran.r-project.org/web/packages/FSA/index.html) R paketindeki `hoCoef` fonksiyonuyla test edelim.
