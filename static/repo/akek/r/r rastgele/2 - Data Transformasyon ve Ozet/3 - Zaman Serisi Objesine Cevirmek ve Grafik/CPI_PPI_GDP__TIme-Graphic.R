...
# Datanin yuklenmesi.
load(file = "CPI_PPI_Processed_Trans.RData", verbose = FALSE)
data <- CPI_PPI_Processed_Trans ## R icine aktarilan bu temizlenmis ve transforme edilmis datanin ismi CPI_PPI_Processed_Trans oldugundan, data ile degistiriliyor.
